...
def get_params(opt, size):
    """Get 2 parameters which will be used in  `get_transform()`."""
    w, h = size
    new_h = h
    new_w = w
...
def get_transform(opt, params=None, grayscale=False, method=Image.BICUBIC, convert=True):
    """Get transformation methods provided by Pytorch."""
    transform_list = []
    if grayscale:
    ...
    # the preprocess of watermarked images should be none otherwidth it will destroy the watermark
...
def __make_power_2(img, base, method=Image.BICUBIC):
    ...
    if h == oh and w == ow:
        ...
        raise ValueError("The height and width of the image should be a multiple of 4")
